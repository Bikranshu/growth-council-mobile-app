        ...
        <View style={styles.contentWrapper}>
          <ScrollView
            ...
            <Text style={styles.headingTitle}>
              (Growth Councel is subsidiary Company of Hyangla Incopration Pvt.
              Ltd.)
            </Text>
            <Text style={styles.paragraph1}>
              ...
              your use in your country or territory of residence (“Home
              Country”). By creating an account for use of the Services in a
              particular country or territory you are specifying it as your Home
              Country. To use our Services, you need compatible hardware,
              software (latest version recommended and sometimes required) and
